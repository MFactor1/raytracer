...
fn main() {
    ...
    let clear_glass = Rc::new(Dielectric::new(Color::new(1.0, 1.0, 1.0), 1.5, 0.05));
    let bubble = Rc::new(Dielectric::new(Color::new(1.0, 1.0, 1.0), 1.0 / 1.5, 0.00));

    let mut world = ObjectSet::new();
    world.push(Sphere::new(Point3::new(-1.0, 0.0, -1.3), 0.5, clear_glass.clone()));
    world.push(Sphere::new(Point3::new(-1.0, 0.0, -1.3), 0.4, bubble.clone()));
    world.push(Sphere::new(Point3::new(1.0, 0.0, -1.3), 0.5, grey_metal.clone()));
    world.push(Sphere::new(Point3::new(0.0, 0.0, -1.5), 0.5, blue_lamb.clone()));
